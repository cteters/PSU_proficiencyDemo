...
//Add a node (with the data value 99) after each node that has a data value LARGER than the last node’s data using a single traversal. Return the number of times 99 is added into the list. DO NOT RE-TRAVERSE!
int list :: add_99()
{
    if(!head)
        return 0;
