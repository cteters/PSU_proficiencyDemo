...
// calculate the average of every data item in a LLL and return the average using a single traversal.

// add a node (with the data value 999) after each node that has a data value LARGER than the last node’s
// data using a single traversal. Return the number of times 99 is added into the list. DO NOT RE-TRAVERSE!
