...
/* These functions are already written and can be called totest out your code */
...
// Rewrite the function to deallocate the entire LLL of arrays. Return the
// number of items removed. THIS TIME use pointer arithmetic!
